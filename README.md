...
### Output
This system emits a plain text file as its output. See the [**output file**](../master/Output/output6/part-t-00000) here. A line stands for a recommendation result for a user and is in this format **"userID,  recommended_movieID:score"**.
